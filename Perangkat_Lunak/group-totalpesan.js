let handler = async (m, { conn }) => { 
     ...
     const namagroup = groupmetadata.subject
     const idgroup = groupmetadata.id
     ...
     const pesan = sortedData 
         ...
         .join('\n'); 
     await m.reply( `
_*TOTAL PESAN GROUP*_

_NAMA GROUP: *${namagroup}*_
_ID GROUP: *${idgroup}*_
_TOTAL PESAN: *${totalM}*_
_DARI: *${totalPeople}* Member_

${pesan}

_DEVELOPER: *@${global.nodev}*_`,
         null, 
         { 
             contextInfo: { 
