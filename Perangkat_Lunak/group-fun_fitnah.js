...
let handler = async (m, { conn, text }) => {
  ...
  const fitnahMessages = [
    ...
    "waduh @user Kata Katanya Sih, Ketahuan Sedang Coli Di Wc",
    "Kata Tetangga Gw @user Ketahuan mengintip Emak Emak Lagi Mandi",
    "Waduh @user Kata Tetangga Gw, Dia Ketahuan Colmek Di Bawah Jembatan, Parah Lu Bro"
  ]
