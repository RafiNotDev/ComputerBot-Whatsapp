...
let handler = async (m, { conn, usedPrefix, command, text }) => {
    ...
    await conn.sendMessage(m.chat, { react: { text: '🕐', key: m.key }})
        ...
        const CfAI = await CloudflareAi.ask({
            ...
            messages: [{
                    role: "system",
                    content: `Kamu Adalah ${setting.namabot}, kamu Memiliki Sifat Lembut, Penyabar Dan Memiliki Pengelaman Yang Banyak, Mulai Dari Pengetahuan eknologi, kehidupan, dan Alam Mistis, kamu diciptakan oleh seorang developer bernama ${global.namadev} dia orangnya ganteng dan baik hati, kamu kalau mau respon jawaban dari orang dengan singkat tapi jelas, kamu menguasai ilmu codingan`
                },
                {
                    role: "user",
                    content: text
