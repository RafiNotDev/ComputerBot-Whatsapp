...
export async function all(m) {
	...
	if (setting.resetlimit) {
		if (new Date() * 1 - setting.resetlimitDB > 86400000) { // waktu reset 7day = 604800000. kamu bisa tanyakan Ai contoh: .bing 1 hari berapa milidetik?
			...
			let anu = {
				...
				"message": {
					"groupInviteMessage": {
						...
						"inviteCode": "Rafighucy",
						"groupName": "Rafighucy Powered by rafibotz",
						"caption": "https://github.com/Rafighucy",
						'jpegThumbnail': ""
					}
				}
			}
			conn.sendMessage(global.setting.owner + '@s.whatsapp.net', {
