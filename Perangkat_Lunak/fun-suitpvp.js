...
let handler = async (m, { conn, usedPrefix, args }) => {
  ...
  if (Object.values(conn.suit).find(room => room.id.startsWith('suit') && [room.p, room.p2].includes(musuh))) return m.reply(`Orang yang kamu tantang sedang bermain suit bersama orang lain :(`)
