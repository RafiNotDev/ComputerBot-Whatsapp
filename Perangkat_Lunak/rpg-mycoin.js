...
`.trim() : ""
    //await conn.sendFile(m.chat, "https://files.catbox.moe/sdyjz7.jpg", null, cap, m)
    conn.adReply(m.chat, cap, `Halo ${name}, ${wish()}`, global.setting.namabot, "https://files.catbox.moe/sdyjz7.jpg", global.setting.namabot, m)
}
handler.help = ["mycoin"]
handler.tags = ["rpg"]
