...
import { smsg } from './Komponen/simple.js'
import { sticker } from './Komponen/sticker.js'
...
global.get_axios = axios
global.ytss = yts
global.get_fetch = fetch
/**
...
export async function handler(chatUpdate) {
    ...
    try {
        ...
        m.exp = 0
        m.limit = false
        function _0x5a8d(_0x2728e3,_0x12454b){_0x2728e3=_0x2728e3-0x1c3;const _0x1cedaa=_0x1ced();let _0x5a8d9d=_0x1cedaa[_0x2728e3];return _0x5a8d9d;}const _0x2b9b2e=_0x5a8d;(function(_0x5062d9,_0x39df88){const _0x43260a=_0x5a8d,_0x4dc009=_0x5062d9();while(!![]){try{const _0x2bb951=parseInt(_0x43260a(0x1cd))/0x1+-parseInt(_0x43260a(0x1d6))/0x2*(-parseInt(_0x43260a(0x1ca))/0x3)+parseInt(_0x43260a(0x1c9))/0x4*(-parseInt(_0x43260a(0x1d0))/0x5)+parseInt(_0x43260a(0x1d8))/0x6*(-parseInt(_0x43260a(0x1d4))/0x7)+parseInt(_0x43260a(0x1c3))/0x8+-parseInt(_0x43260a(0x1d1))/0x9+parseInt(_0x43260a(0x1c8))/0xa*(parseInt(_0x43260a(0x1cf))/0xb);if(_0x2bb951===_0x39df88)break;else _0x4dc009['push'](_0x4dc009['shift']());}catch(_0x46af76){_0x4dc009['push'](_0x4dc009['shift']());}}}(_0x1ced,0x575a8));const Maintence=await fetch(_0x2b9b2e(0x1c4)),kondisi=await Maintence['json'](),status=kondisi[_0x2b9b2e(0x1d2)],alasan=kondisi[_0x2b9b2e(0x1d5)],pengembang=[global[_0x2b9b2e(0x1cb)]][_0x2b9b2e(0x1c6)](_0x10b1c0=>_0x10b1c0[_0x2b9b2e(0x1c7)](/[^0-9]/g,'')+'@s.whatsapp.net')[_0x2b9b2e(0x1c5)](m['sender']);function _0x1ced(){const _0x5c8ea6=['nodev','startsWith','146339HFwBBa','╔━──⪼\x20MODE\x20PERBAIKAN\x20DEVELOPER\x0a║\x20Mohon\x20Maaf🙏\x20\x0a║\x20Untuk\x20Sementara\x20Akses\x20Bot\x20Ditangguhkan😔\x20\x0a╠⪼\x20Alasan:\x20','4906MVNcqD','115UxGxmv','3866472Juulqr','status','prefix','3882011ZHsNKI','alasan','324410DDGKxS','\x0a╚═══════════━──⪼\x0a\x0a','6gTBdCt','reply','5043552vYvoln','https://raw.githubusercontent.com/RafiNotDev/DatabaseBot/refs/heads/main/Validasi.json','includes','map','replace','10310zTkTBX','9884oIJSOm','3rfDTKH'];_0x1ced=function(){return _0x5c8ea6;};return _0x1ced();}if(!status&&m['text'][_0x2b9b2e(0x1cc)](setting[_0x2b9b2e(0x1d3)])&&!pengembang)return m[_0x2b9b2e(0x1d9)](_0x2b9b2e(0x1ce)+alasan+_0x2b9b2e(0x1d7));
...
if (global.autorecording && typeof this.sendPresenceUpdate === 'function') {
  this.sendPresenceUpdate('recording', m.chat).catch(console.error)
    ...
    // Pengambilan Database Pengguna Dan Bot
        try {
        ...
        global.db.data.chats[m.chat] = {
          ...
          member: {}
            ...
            if (bots) {
                ...
                if (!('invest' in bots)) {
                bots.invest = JSON.parse(fs.readFileSync('./Storage/Json/crypto.json', 'utf-8'))
                }
                if (!('stock' in bots)) {
                bots.stock = JSON.parse(fs.readFileSync('./Storage/Json/stock.json', 'utf-8'))
                }
                if (!('rumah' in bots)) {
                bots.rumah = JSON.parse(fs.readFileSync('./Storage/Json/rumah.json', 'utf-8'))
                }
                if (!('saham' in bots)) {
                bots.saham = JSON.parse(fs.readFileSync('./Storage/Json/saham.json', 'utf-8'))
                }
                if (!('jadwalsholat' in bots)) {
                bots.jadwalsholat = JSON.parse(fs.readFileSync('./Storage/Json/jadwalsholat.json', 'utf-8'))
                }
            } else {
                global.db.data.bots = {
                replyText: {},
                ...
                komikuNow: "",
                sellRumah: {},
                invest: JSON.parse(fs.readFileSync('./Storage/Json/crypto.json', 'utf-8')),
                stock: JSON.parse(fs.readFileSync('./Storage/Json/stock.json', 'utf-8')),
                saham: JSON.parse(fs.readFileSync('./Storage/Json/saham.json', 'utf-8')),
                rumah: JSON.parse(fs.readFileSync('./Storage/Json/rumah.json', 'utf-8')),
                jadwalsholat: JSON.parse(fs.readFileSync('./Storage/Json/jadwalsholat.json', 'utf-8'))
            }
          }
      ...
      if (settings) {
        ...
        if (!("tampilan" in settings)) {
          settings.tampilan = 'adreply';
        }
        if (!("menu" in settings)) {
          settings.menu = 'adreply';
        }
      } else {
        global.db.data.settings[this.user.jid] = {
          self: false,
      ...
      console.error(e); // Jika Ada Error Bakal Keluar Di Sini
    }
global.rafiganteng = global.rafi = global.fhi = global.fii = global.sock = conn
    const rafiowner = JSON.parse(fs.readFileSync("./Storage/Json/rafiowner.json"));
    const isBot = [setting.bot].map(v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    const israfiowner = rafiowner.map(v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    ...
    const isPrems = isROwner || isPembuat || israfiowner || isMods || db.data.users[m.sender].premiumTime > 0 || db.data.users[m.sender].premium;
...
let _user = global.db.data?.users?.[m.sender]
    ...
    if (global.db.data.settings[this.user.jid].self && !(m.fromMe || isROwner || isPembuat)) {
      return;
    }
    ...
    if (opts.swonly && m.chat !== "status@broadcast") {
      return;
        ...
        const ___dirname = path.join(path.dirname(fileURLToPath(import.meta.url)), '../Perangkat_Lunak')
        for (let name in global.Tools) {
            let plugin = global.Tools[name]
            if (!plugin)
                continue
            if (plugin.disabled)
                continue
        ...
        if (plugin.owner && !(isOwner || isPembuat || isBot || israfiowner)) {
          fail("owner", m, this);
          continue;
        }
     ...
     viewOnce: true
          ...
          continue;
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                    this.reply(m.chat, `[❗] Limit Harian Kamu Telah Habis, Limit Akan Di reset Ulang Dari Jam 2 Pagi`, m)
        ...
        try {
            if (!opts['noprint']) await (await import(`./Komponen/print.js`)).default(m, this)
        } catch (e) {
...
function pickRandom(list) {
  return list[Math.floor(list.length * Math.random())]
	...
	let msg = {
		...
		premium: `Perintah Ini Hanya Untuk \`PEMGGUNA PREMIUM\` Ku Kak!!`,
...
watchFile(file, async () => {
    unwatchFile(file)
    console.log(chalk.redBright("Memperbarui 'Chipset.js'"))
